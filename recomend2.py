...
class recommender:
    ...
    def recommend(self, user):
        ...
        for i in range(self.k):
            ...
            for artist, value in neighborRatings.items():
                print("\ntamaño de recomendaciones" ,len(recommendations))
                print("artist:", artist, 'value', value)
                if len(recommendations) <= parametro_limite:
                    if not artist in userRatings:
                        if artist not in recommendations:
                            if value > parametro_recomendacion:
                                #recommendations[artist] = (neighborRatings[artist] * weight)
                                #print("Recomendacion", artist, "-", recommendations[artist])
                                string = name,"-",artist
                                print("Recomendacion",string)
                                recommendations_array.append(string)
                        else:
                            if value > parametro_recomendacion:
                                ...
                                print(" No Recomendacion")

                    else:
                        print(" No Recomendacion")
                else:
                    print("Recomendaciones completas")

        #print("\n-> Recomendaciones Finales=", recommendations, "para:", user)
       #print("\nRecommendations array",recommendations_array, "para:", user)
